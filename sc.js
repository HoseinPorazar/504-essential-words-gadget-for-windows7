...
function ok()
{
	 var words =[["abandon", "keen", "jealous", "tact", "oath", "vacant", "hardship", "gallant", "data", "unaccustomed", 
            "bachelor", "qualify"],
...
document.getElementById("word").innerHTML=words[lessonNo][wordNo]+":";
document.getElementById("mean").innerHTML=meaning[lessonNo][wordNo];
...
function change()
{
	...
	lessonNo=document.getElementById("combo").selectedIndex;
	wordNo=0;
	ok();
}
function prev()
...
function checkedd()
{
 ...
 {
	myVar =setInterval(function(){next()},60000);
 }
 else if(document.getElementById("ck").checked==false)
 {
	try
	{
	clearInterval(myVar);
